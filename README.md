...
Проект вдохновлён идеями [onec-docker](https://github.com/firstBitMarksistskaya/onec-docker). Я выделил все образы на базе OneScript в отдельный репозиторий, так как мне это показалось более логичным. Так как собранные образы 1С нельзя размещать в публичных registry, а образы на базе OneScript можно размещать публично. А также расширил список собираемых инструментов, добавил автосборку и тестирование образов.
